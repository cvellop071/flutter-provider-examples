...
class DataModel with ChangeNotifier {
  ...
  void updateData1(String newData) {
    _data1 = newData;
    debugPrint("updateData1: $_data1");
    notifyListeners();
  }

  void updateData2(String newData) {
    _data2 = newData;
    debugPrint("updateData2: $_data2");
    notifyListeners();
  }
}
...
class ExampleSelector extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Example Selector'),
      ),
      ...
      //-------------------------------------------
          child: Column(
            ...
            children: [
              ...
              //___________________________________________
              Selector<DataModel,String>(
                selector: (context, dataModel) => dataModel.data1, 
                builder: (context, data1, child) {
                  debugPrint("Selector data1 reloaded: $data1");
                  return Text("Dato1: $data1");
                },
              ),
              //--------------------------------------------
              ElevatedButton(
                ...
                child: const Text('Update Data1'),
                            ...
                            //___________________________________________
              Selector<DataModel,String>(
                selector: (context, dataModel) => dataModel.data2,
                builder: (context, data2, child) {
                  debugPrint("Selector data2 reloaded: $data2");
                  return Text('Dato2: $data2');
                },
              ),
              //--------------------------------------------
              ElevatedButton(
